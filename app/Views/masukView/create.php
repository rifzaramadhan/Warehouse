            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('masuk/save'); ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" placeholder="Keterangan.." name="keterangan" id="keterangan" value="<?= old('keterangan'); ?>">
                                    <div class="invalid-feedback">
